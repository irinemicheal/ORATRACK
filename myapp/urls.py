...
path('adm_patient_details/<int:id>/', views.adm_patient_details, name='adm_patient_details'),
 ...
 path('p_appointment_status/', views.view_appointments, name='p_appointment_status'),
   ...
   path('dr_all_chemo/', views.dr_all_chemo, name='dr_all_chemo'),
   path('dr_all_radio/', views.dr_all_radio, name='dr_all_radio'),
...
path('admin_delete_doctor/<int:doctor_id>/', views.admin_delete_doctor, name='admin_delete_doctor'),
path('edit_lab/<int:lab_id>/', views.edit_lab, name='edit_lab'),
